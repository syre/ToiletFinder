...
import com.example.toiletfinder.utils.DeviceID;
 ...
 *
 *  Dale Lane (dale.lane@gmail.com)  http://dalelane.co.uk/blog/?p=1599
 *    28 Jan 2011
 */
public class MqttServiceTwo extends Service implements MqttCallback {
    ...
    private String brokerHostName = "192.168.43.18";
    // taken from preferences
    //    topic we want to receive messages about
    //    can include wildcards - e.g.  '#' matches anything
    private String topicName = "client4";


    // defaults - this sample uses very basic defaults for it's interactions
    //   with message brokers
    private int brokerPortNumber = 1883;
    private MqttClientPersistence mqttClientPersistence = null;
    ...
    private short keepAliveSeconds = 20 * 60; // seconds
    ...
    private String mqttClientId = DeviceID.getID();
...
//    private PingSender pingSender;
    ...
    public void onCreate() {
        ...
        mBinder = new LocalBinder<MqttServiceTwo>(this);
        ...
        final SharedPreferences settings = getSharedPreferences(APP_ID, MODE_PRIVATE);
...
//                new IntentFilter(ConnectivityManager.ACTION_BACKGROUND_DATA_SETTING_CHANGED));
    ...
    synchronized void handleStart(Intent intent, int startId) {
        ...
        if (cm.getActiveNetworkInfo() == null) // respect the user's request not to use data!
        {
        ...
        if (!isAlreadyConnected()) {
            ...
            Notification.Builder notificationBuilder = new Notification.Builder(this)
                    .setSmallIcon(R.drawable.toilet)
                    .setTicker("MQTT")
            ...
            Intent notificationIntent = new Intent(this, MqttServiceTwo.class);
            PendingIntent contentIntent = PendingIntent.getActivity(this, 0,
                    notificationIntent,
                    PendingIntent.FLAG_UPDATE_CURRENT);

            notificationBuilder.setContentTitle("MQTT").setContentText("MQTT Service is running").setContentIntent(contentIntent);
            nm.notify(MQTT_NOTIFICATION_ONGOING, notificationBuilder.build());
            ...
            if (isOnline()) {
                ...
                if (connectToBroker()) {
                    ...
                    subscribeToTopic(settings.getString(VARS.MQTT_TOPICS,topicName));
                }
            } else {
...
//        NotificationManager nm = (NotificationManager) getSystemService(NOTIFICATION_SERVICE);
//
//        Notification notification = new Notification(R.drawable.toilet, alert,
...
//    }
    ...
    private LocalBinder<MqttServiceTwo> mBinder;
...
//            notifyUser("New data received", topic, messageBody);
    ...
    private void defineConnectionToBroker(String brokerHostName) {
        ...
        try {
            // define the connection to the broker
            mqttClient = new MqttClient(mqttConnSpec, mqttClientId, mqttClientPersistence);
...
//            notifyUser("Unable to connect", "MQTT", "Unable to connect");
    ...
    private boolean connectToBroker() {
        try {
            ...
            mqttConnectOptions.setCleanSession(cleanStart);
            mqttConnectOptions.setKeepAliveInterval(keepAliveSeconds);
...
//            notifyUser("Unable to connect", "MQTT", "Unable to connect - will retry later");
    ...
    private void subscribeToTopic(String topicName) {
        ...
        final int[] topivQoS = new int[topicNames.length];
        ...
        if (!isAlreadyConnected()) {
            ...
            try {
                mqttClient.subscribe(topicNames, topivQoS);
...
//todo - perhaps we need a specific pingsender
//    /*
...
//    }
    ...
    public void messageArrived(MqttTopic mqttTopic, MqttMessage mqttMessage) throws Exception {
        broadcastReceivedMessage(mqttTopic.getName(), new String(mqttMessage.getPayload(), "UTF-8"));
    }
